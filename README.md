...
You need to purchase Clickteam Fusion 2.5+ to use it. Make sure to install the most recent version of [**SDL**](https://github.com/SortaCore/SDLJoystick-priv) and the Studiopolis shader to make this works.
