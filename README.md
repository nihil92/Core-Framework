...
You need to purchase a legit [**Clickteam Fusion 2.5+**](https://store.steampowered.com/app/1056780/Clickteam_Fusion_25_Addon/) copy to use it. Make sure to install the most recent version of [**SDL**](https://github.com/SortaCore/SDLJoystick-priv) and the included shaders to make this works.
