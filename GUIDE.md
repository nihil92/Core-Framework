...
There are, however, some shader limitations depending on which DirectX you use. The image must necessarily be 2x256, even though it doesn't fill all the space (you can leave a transparent space in this case). DX9 is limited to 32 colors, while DX11 is limited to 256.
